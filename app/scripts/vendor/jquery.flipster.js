...
//			_flipItemsOuter.css("height",_flipItems.height());
			_flipItemsOuter.css("height", "210px");
			_flipster.css("height","auto");
//			if ( settings.style === 'carousel' ) { _flipItemsOuter.width(_flipItems.width()); }
			if ( settings.style === 'carousel' ) { _flipItemsOuter.width(354); }
			
			if ($(window).width() <= 750)
			{
				if ( settings.style === 'carousel' ) { _flipItemsOuter.width(324); }
			}
		}
...
//				if (!$(thisItem).hasClass("flip-current")) $(thisItem).find(".btn").fadeOut(250);
//			}
//			$(currentItem).find(".btn").delay(250).fadeIn(500);
